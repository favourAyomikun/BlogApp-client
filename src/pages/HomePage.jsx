  ...
  return (
    <main>
      ...
      <div>
        ...
        <h1 className="mt-10 md:mt-16 ml-10 md:ml-12 text-xl sm:text-2xl md:text-3xl font-bold tracking-wide text-[#888888]">
          Popular Trends
        </h1>
        <ul className="flex mx-10 md:mx-12 text-sm sm:text-base md:text-lg space-x-4 my-4 md:my-7 cursor-pointer text-[#888888]">
